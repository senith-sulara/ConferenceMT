...
import {saveRPPayment} from "../../services/rpPayment.service";

export default class PublicationPayment extends Component {
    ...
    constructor(props) {
        ...
        this.submitRPPayment = this.submitRPPayment.bind(this);
    ...
    submitRPPayment(event) {
        ...
        const RPPaymentDetails = {
            cardType: this.state.cardType,
            cardNumber: this.state.cardNumber,
            expire: this.state.expire,
            cvv: this.state.cvv,
            holder: this.state.holder,
            amount: this.props.location.rpAmount,
            researchPaperId: this.props.location.rpId,
            researchPaperName: this.props.location.rpName,
            user: localStorage.getItem("CustomerId")
        }
        console.log(RPPaymentDetails);

        saveRPPayment(RPPaymentDetails).then(res => {
                    ...
                    <MDBCardBody className="mx-2">
                        <div className="text-center">
                            <h2 className="loginh3 mb-1">
                                <strong className="loginh3 ">Research Paper Payment</strong>
                            </h2>
                        </div>
                        <form className="needs-validation" onSubmit={this.submitRPPayment} noValidate>
                            <MDBRow>
                            ...
                            <MDBRow>
                                ...
                                <input onChange={this.onChangeAmount}
                                       value={this.props.location.rpAmount}
                                       type="number"
